...
| `edist_def`, `edist_eq_dInfUnion`, `edist_self_profile`, `edist_symm_profile`, `edist_triangle_profile`, `edist_le_one_profile`, `mem_emetric_ball_iff_dInfUnion_lt` | Profile-space pseudo-emetric helper API; `edist` is definitionally the union-form profile distance | `machine_verified_theorem` |
...
| `generatedBy`, `generatedBy_step`, `generatedBy_step_projectedProfile`, `generatedBy_step_branchProfile`, `generatedBy_step_oneStepBranch` | Predicate that a supplied trajectory follows deterministic action-indexed projection, plus direct, branch-profile, and one-step-branch step equations | `machine_verified_definition`; `machine_verified_theorem` |
...
| `stepUnionDistance`, `stepUnionDistance_nonneg`, `stepUnionDistance_le_one`, `generatedBy_stepUnionDistance_eq_projectedProfile`, `generatedBy_stepUnionDistance_eq_oneStepBranch` | Adjacent-time union-domain profile distance, basic bounds, and generated-trajectory unfold helpers | `machine_verified_definition`; `machine_verified_theorem` |
| `stepSharedDistance`, `stepSharedDistance_nonneg`, `stepSharedDistance_le_one_of_nonempty`, `stepSharedDistance_top_iff`, `generatedBy_stepSharedDistance_eq_projectedProfile`, `generatedBy_stepSharedDistance_eq_oneStepBranch` | Adjacent-time shared-domain profile distance, guarded bound/top characterization, and generated-trajectory unfold helpers | `machine_verified_definition`; `machine_verified_theorem` |
...
| `oneStepBranch`, `oneStepBranch_eq_branchProfile`, `oneStepBranch_eq_projectedProfile`, `oneStepBranchUnionDistance`, `oneStepBranchUnionDistance_eq_dInfUnion`, `oneStepBranchUnionDistance_eq_projectedProfile`, `oneStepBranchUnionDistance_nonneg`, `oneStepBranchUnionDistance_le_one`, `oneStepBranchUnionDistance_self`, `oneStepBranchUnionDistance_symm`, `oneStepBranchUnionDistance_triangle` | One-step deterministic branch profile and union-distance naming bridges, bounds, and metric-style helper theorems | `machine_verified_definition`; `machine_verified_theorem` |
