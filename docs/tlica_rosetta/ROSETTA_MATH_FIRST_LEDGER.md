...
| TMP-002 | Deterministic generated trajectory | Predicate verifying that a supplied trajectory follows deterministic projection, with named generated-step, future-content, one-step branch, and generated-distance unfold helpers | `generatedBy`, `generatedBy_step`, `generatedBy_step_projectedProfile`, `generatedBy_step_branchProfile`, `generatedBy_step_oneStepBranch`, `trajectoryFutureContents`, `trajectoryFutureContents_eq_branchFutureContents`, `trajectoryFutureContents_eq_futureMSIContents`, `oneStepBranch`, `oneStepBranch_eq_branchProfile`, `oneStepBranch_eq_projectedProfile`, `oneStepBranchUnionDistance`, `oneStepBranchUnionDistance_eq_dInfUnion`, `oneStepBranchUnionDistance_eq_projectedProfile`, `oneStepBranchUnionDistance_*` | `machine_verified_definition`; `machine_verified_theorem` | temporal-trajectory layer |
| TMP-003 | Stepwise temporal stability | Adjacent profile distances, generated-trajectory distance rewrites, shared-distance guarded facts, uniform/eventual stability predicates, and later-start/uniform-to-eventual bridges | `stepUnionDistance`, `stepUnionDistance_nonneg`, `stepUnionDistance_le_one`, `generatedBy_stepUnionDistance_*`, `stepSharedDistance`, `stepSharedDistance_nonneg`, `stepSharedDistance_le_one_of_nonempty`, `stepSharedDistance_top_iff`, `generatedBy_stepSharedDistance_*`, `unionStepStable`, `unionStepStable_step_le`, `eventuallyUnionStepStable`, `eventuallyUnionStepStable_of_le_start`, `eventuallyUnionStepStable_of_unionStepStable` | `machine_verified_definition`; `machine_verified_theorem` | temporal-trajectory layer |
...
| PRF-008 | Pseudo-emetric promotion | Extended pseudometric structure on profile space, with helper bridges from `edist` to the union-form distance | `ProfileSpace`, `PseudoEMetricSpace` instance, `edist_def`, `edist_eq_dInfUnion`, `edist_self_profile`, `edist_symm_profile`, `edist_triangle_profile`, `edist_le_one_profile`, `mem_emetric_ball_iff_dInfUnion_lt` | `machine_verified_definition`; `machine_verified_theorem` | round-3/4 follow-up |
