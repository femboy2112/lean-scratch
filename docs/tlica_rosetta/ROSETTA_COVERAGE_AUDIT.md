...
| AGY-001 to AGY-005 | Agency witness layer and finite feasible maximizer existence | has multiple Lean declarations | `FeasibilityModel`, `AgencyContext`, `selectsFeasibleAction`, `AgencyWitness`, live/PCE-differentiated predicates, `exists_selectsFeasibleAction_of_finset` | First structural witness layer plus finset-enumerated finite feasible selection theorem; no unrestricted global agency existence. |
...
| TMP-001 to TMP-004 | Deterministic temporal trajectory substrate | has multiple Lean declarations | `ProfileTrajectory`, `ActionSchedule`, `generatedBy`, stability/divergence declarations, step-distance bounds | Supplied/verified trajectories only; no global trajectory existence. |
...
| AFF-001 to AFF-006 | Profile/PCE affect kernel | has multiple Lean declarations | PCE valence, branch shift and branch-distance bounds, affect witness, bridge, collapse, intensity declarations | Generic kernel only, not named affect taxonomy. |
