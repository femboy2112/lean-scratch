...
| PRF-005 to PRF-006 | Shell thresholds and interior/same-shell bounds | has multiple Lean declarations | `ShellThresholds`, `shellOf`, `ShellIndex7`, `shellOf7`, `sameShellBound*`, `sameInteriorShell_distance_bound`, `interiorShell_pair_bound`, `sameCogitoShell_bound`, `sameOuterShell_bound`, `shellStableDistanceBound_of_pointwise` | Machine-verified interior and source-fixed boundary shell definitions/theorems. |
| PRF-007 | Full seven-shell shell-stratified bound | has Lean theorem | `fullShellStratifiedBound`; legacy `shellStratifiedBound_deferred` | Full pointwise bound is machine-verified; legacy marker is superseded. |
...
| TMP-001 to TMP-004 | Deterministic temporal trajectory substrate | has multiple Lean declarations | `ProfileTrajectory`, `ActionSchedule`, `generatedBy`, generated-step helpers, stability/divergence declarations, step-distance bounds | Supplied/verified trajectories only; no global trajectory existence. |
