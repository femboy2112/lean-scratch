...
3. ~~`codex/tlica-profile-space-helpers-v0`~~ - **done**:
   added convenience lemmas for `ProfileSpace`, `edist_def`, and the
   pseudometric/profile-distance API without changing the underlying
   distance definitions.

4. `codex/tlica-contestable-boundary-source-refinement-v0`
